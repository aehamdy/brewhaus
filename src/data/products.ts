...
export const products = [
  // Coffee Category
  {
    ...
    options: [
      { size: "Small" },
      { size: "medium", value: "(+$1.35)" },
      { size: "large", value: " (+$2.1)" },
    ],
  ...
  },
  {
    ...
    options: [{ size: "small" }, { size: "medium", value: "(+$1.2)" }],
    allergens: ["milk", "soy"],
  ...
  },
  {
    ...
    options: [{ size: "small" }, { size: "medium", value: "(+$0.85)" }],
  ...
  },
  {
    ...
    options: [
      { size: "small" },
      { size: "medium", value: "(+$1.1)" },
      { size: "large", value: "(+$1.55)" },
    ],
  ...
  },
  {
    ...
    options: [
      { size: "small" },
      { size: "medium", value: "(+$1.3)" },
      { size: "large", value: "(+$1.9)" },
    ],
  ...
  // Bakery Category
  {
    ...
    options: [{ size: "single" }, { size: "pack of 3", value: "(+$2.9)" }],
  ...
  },
  {
    ...
    options: [{ size: "single" }, { size: "pack of 3", value: "(+$3.4)" }],
  ...
  },
  {
    ...
    options: [{ size: "single" }, { size: "pack of 3", value: "(+$2.4)" }],
    allergens: ["milk", "wheat", "eggs", "soy"],
    image: donutImage,
  },
  {
    ...
    options: [{ size: "single" }, { size: "pack of 3", value: "(+$3.2)" }],
    allergens: ["milk", "wheat", "eggs", "soy"],
    image: muffinImage,
  },
  {
    ...
    options: [{ size: "single" }, { size: "pack of 3", value: "(+$2.1)" }],
